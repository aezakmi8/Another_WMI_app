...
public class Class2
{
    ...
    static void Show_Info(string[] args)
    {
...
{
    //static void HaardCol()
    //{
    //    string[] array2D = new string[] { { "Win32_Processor", "Name", "Manufacturer", "Description" }, { "Description" } };

    //    var salmons = new string[] { new { "Win32_Processor", "Name", "Manufacturer", "Description" }, { "Description" } };
    //}
}